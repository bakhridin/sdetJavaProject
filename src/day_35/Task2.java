...
public class Task2 {
    ...
    public static Map<String, String> firstChar3(String[] strings) {
        HashMap<String,String> map=new HashMap<>();
    ...
    public static Map<String, String> firstChar4(String[] strings) {
        HashMap<String,String> map=new HashMap<>();
        for (String str : strings) {
    ...
    public static void main(String[] args) {
        String[] str={"home","point","perf","shar","safar"};

//        Map<String, String> stringStringMap4 = firstChar4(str);
//        System.out.println("stringStringMap4 = " + stringStringMap);

        Map<String, String> stringStringMap3 = firstChar3(str);
        System.out.println("stringStringMap3 = " + stringStringMap3);
